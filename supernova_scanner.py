...
DEFAULT_BASKET = [
    # original 7 (keep for continuity)
    "ORIC", "VSTM", "OLMA", "NUVB", "KYMR", "RXRX", "CRBU",
    # widened biotech basket — small/mid-cap clinical-stage & platform
    "SANA", "BEAM", "NTLA", "CRSP", "FATE", "RLAY", "ARVN", "IMVT",
    "KROS", "RCKT", "DAWN", "TSHA", "VERA", "AVXL", "PGEN", "CGEM",
    "MREO", "CABA",
]
...
def build(tickers):
    ...
    html = (f'<!DOCTYPE html><html lang="en"><head><meta charset="UTF-8">'
            ...
            f'<title>Supernova Scanner</title>'
            ...
            f'<div class="eyebrow">Supernova study · daily gaps + {INTRADAY_INTERVAL} shape · biotech basket</div>'
            f'<h1>Supernova Scanner</h1>'
    ...
    with open("supernova.html", "w") as f:
        f.write(html)
    print("\nWrote supernova.html")
    print("Open with:  open supernova.html")

...
DEFAULT_BASKET = [
    # low-float cannabis / MSO complex — the biotech analog:
    # low float + binary catalysts (legislation, earnings, offerings) + retail crowd
    "TLRY", "CGC", "ACB", "SNDL", "OGI", "CRON", "VFF",
    "GRWG", "AKAN", "CURLF", "GTBIF", "TCNNF", "CRLBF", "AAWH",
    "MSOS", "YOLO", "HITI", "SHWZ", "MRMD", "GDNSF", "TSNDF", "CLVR",
]
...
def build(tickers):
    ...
    html = (f'<!DOCTYPE html><html lang="en"><head><meta charset="UTF-8">'
            ...
            f'<title>Cannabis Supernova Scanner</title>'
            ...
            f'<div class="eyebrow">Cannabis supernova study · daily gaps + {INTRADAY_INTERVAL} shape · cannabis basket</div>'
            f'<h1>Cannabis Supernova Scanner</h1>'
    ...
    with open("cannabis_supernova.html", "w") as f:
        f.write(html)
    print("\nWrote cannabis_supernova.html")
    print("Open with:  open cannabis_supernova.html")

...
DEFAULT_BASKET = [
    # pure-play Bitcoin miners — the CORRELATED-catalyst test.
    # These all move on BTC's price, not on stock-specific news, so the
    # hypothesis is they behave CANNABIS-like (weak/noisy, no clean threshold)
    # rather than biotech-like. IREN deliberately EXCLUDED (AI-datacenter pivot).
    "MARA", "RIOT", "CLSK", "BITF", "HUT", "CIFR", "WULF", "CORZ",
...
def build(tickers):
    ...
    html = (f'<!DOCTYPE html><html lang="en"><head><meta charset="UTF-8">'
            ...
            f'<title>Bitcoin Miner Supernova Scanner</title>'
            ...
            f'<div class="eyebrow">Bitcoin-miner supernova study · daily gaps + {INTRADAY_INTERVAL} shape · Bitcoin-miner basket</div>'
            f'<h1>Bitcoin Miner Supernova Scanner</h1>'
    ...
    with open("mining_supernova.html", "w") as f:
        f.write(html)
    print("\nWrote mining_supernova.html")
    print("Open with:  open mining_supernova.html")
